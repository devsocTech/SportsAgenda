...
export default (props)=>{
    return(
        ...
        <View style={{flex:0, paddingTop:'30%'}}>
            ...
            <Button theme={theme} style={{borderWidth:2,borderColor: 'white',width: '75%', alignSelf:'center', margin:13}} onPress={()=>props.navigationAction1()} mode="outlined">Registrarse</Button>
        </View>
        </ImageBackground>
    );
}
