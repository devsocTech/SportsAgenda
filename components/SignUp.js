...
export default (props)=>{
    ...
    return(
        ...
        <View style={{justifyContent:'center', flex:1}}>
            ...
            <TextInput style={{alignSelf:'center' , width:'75%'}} label="Contraseña" onChangeText={(text)=>props.setPassword1(text)}>{props.Pass}</TextInput>
            <TextInput style={{alignSelf:'center', width:'75%'}} label="Confirmar Contraseña" onChangeText={(text)=>props.setPassword2(text)}>{props.Pass2}</TextInput>
